...
<script>
    /**
     * @typedef {import('svelte/elements').HTMLAnchorAttributes & ButtonVariants & { link: true }} AnchorProps
     */

    /**
     * @typedef {import('svelte/elements').HTMLButtonAttributes & ButtonVariants & { link: false }} ButtonProps
     */
